...
<?php include('../includes/topnav.php'); ?>
  ...
  <header id="dis-hero" class="l-fullpage-header flex flex-center just-center flex-wrap text-shade link-no-shad">
    <div class="container no-pad">
      <div class="l-fullpage-header-content no-pad-sides butt-link-light-lg link-hover-disco ">
        ...
        <h1>Disability Income <span class="smart-break">Insurance Guide</span></h1>
        <hr>
