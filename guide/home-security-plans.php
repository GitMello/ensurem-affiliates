...
<?php include('../includes/topnav.php'); ?>
  ...
  <header id="homesec-hero" class="l-fullpage-header flex flex-center just-center flex-wrap text-shade link-no-shad">
    <div class="container no-pad">
      <div class="l-fullpage-header-content no-pad-sides butt-link-light-lg link-hover-homeseco ">
        ...
        <h1>Home Security <span class="smart-break">Plans Guide</span></h1>
        <hr>
